...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE settings SET title=?, account=?, home_ticket=?, photography_ticket=?, standpoint_ticket=?, comment_ticket=?";
    $params = [$title, $account, $home_ticket, $photography_ticket, $standpoint_ticket, $comment_ticket];
    $types = "ssssss";
    ...
    <div class="item">
        <section class="form">
            <form method="POST" id="setForm">
                ...
                <li><span>password</span><div class="input wide-20"><input type="password" name="password" placeholder="leave blank to keep"><o class="password"></o></div></li>
