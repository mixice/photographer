...
<script>function del(id){confirm('Delete will remove related files and comments, confirm ?').then(r=>{if(r)location.href='standpoint.php?action=delete&id='+id})}</script>
